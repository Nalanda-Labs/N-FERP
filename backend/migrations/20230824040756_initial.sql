...
create table users (
  ...
  phone_other varchar(32) default '',
  phone_fax varchar(32) default '',
  ...
  address_postalcode varchar(20) default '',
  deleted boolean default false,
  portal_only boolean default false,
  show_on_employees boolean default true,
  employee_status varchar(100) default '',
  messenger_id varchar(100) default '',
  messenger_type varchar(100) default '',
  reports_to_id uuid default null,
  is_group boolean default null,
  factor_auth boolean default false not null,
